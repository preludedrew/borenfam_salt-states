...
def __virtual__():
    ...
    '''
    return 'zbx.host_create' in __salt__
...
def present(host, groups, interfaces, **kwargs):
    ...
    host_exists = __salt__['zbx.host_exists'](host)
    ...
    if host_exists:
        ...
        host_create = __salt__['zbx.host_create'](host, groups, interfaces, **kwargs)
...
def absent(name):
    ...
    host_exists = __salt__['zbx.host_exists'](name)
    ...
    host_get = __salt__['zbx.host_get'](name)
    ...
    if not host_get:
        ...
        try:
            ...
            host_delete = __salt__['zbx.host_delete'](hostid)
        except KeyError:
            host_delete = False
